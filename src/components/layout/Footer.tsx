        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/integrations" className="text-sm text-gray-600 hover:text-gray-900">
                  Integrations
                </Link>
              </li>
              <li>
                <Link to="/roadmap" className="text-sm text-gray-600 hover:text-gray-900">
                  Roadmap
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/refund-policy" className="text-sm text-gray-600 hover:text-gray-900">
                  Refund Policy
                </Link>
              </li>
              <li>
